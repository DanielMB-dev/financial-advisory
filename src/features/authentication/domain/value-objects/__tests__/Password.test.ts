...
describe('Password Value Object', () => {
  describe('create', () => {
    ...
    it('should reject password with less than 8 characters', () => {
      expect(() => Password.create('Pass1')).toThrow('Password must be at least 8 characters')
    })
    ...
    it('should reject password without number', () => {
      expect(() => Password.create('Password')).toThrow('Password must contain at least one number')
    })

    it('should accept password with all requirements', () => {
      const validPasswords = ['Password123', 'MyP@ssw0rd', 'Secure1Password', 'Test1234']
