...
import { DuplicateEmailError, InvalidCredentialsError } from '../../../domain/errors/AuthenticationErrors';
...
describe('SupabaseAuthAdapter', () => {
  ...
  describe('registerWithEmail', () => {
    ...
    it('should throw DuplicateEmailError if email already exists', async () => {
      ...
      await expect(adapter.registerWithEmail(email, password)).rejects.toThrow(
        DuplicateEmailError
      );
    });
  });
  ...
  describe('loginWithEmail', () => {
    ...
    it('should throw InvalidCredentialsError on wrong password', async () => {
      ...
      await expect(adapter.loginWithEmail(email, password)).rejects.toThrow(
