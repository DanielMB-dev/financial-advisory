...
describe('SupabaseSessionAdapter', () => {
  ...
  describe('createSession', () => {
    ...
    it('should throw error if session creation fails', async () => {
      ...
      await expect(adapter.createSession('invalid-token', 'invalid-refresh')).rejects.toThrow(
  ...
  describe('refreshSession', () => {
    ...
    it('should throw SessionExpiredError if refresh fails', async () => {
      ...
      await expect(adapter.refreshSession('invalid-token')).rejects.toThrow(SessionExpiredError)
    })
  })
