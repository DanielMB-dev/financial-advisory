...
import { createRouteHandlerSupabaseClient } from '../supabase/route-handler-client'
import { User } from '../../domain/entities/User'
import { SessionExpiredError } from '../../domain/errors/AuthenticationErrors'

/**
 * Session manager for Route Handlers (API routes)
 * Uses the route-handler-specific Supabase client that properly handles cookies
 */
export class SupabaseRouteHandlerSessionAdapter implements ISessionManager {
